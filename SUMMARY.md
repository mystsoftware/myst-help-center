...
* [How do I use the MyST REST API to automate creation of resources in MyST using Jenkins?](platform-configuration/creating-myst-studio-resources-using-rest-apis-with-help-of-jenkins.md)
