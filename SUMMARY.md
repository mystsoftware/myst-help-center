...
* [Need to handle scaling nodes by using shared directories for aserver/mserver domains and product binaries?](platform-configuration/shared-storage-for-domain-and-product-binaries.md)
