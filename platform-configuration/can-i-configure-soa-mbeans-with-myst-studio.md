...
| em.log.handlers | Global Variables | `em.log.handlers=odl-soa1`<br>`em.log.handler.odl-soa1.name=odl-handler`<br>`em.log.handler.odl-soa1.maxFileSize=11M`<br>`em.log.handler.odl-soa1.retentionPeriod=week`<br>`em.log.handler.odl-soa1.rotationFrequency=day`<br>`em.log.handler.odl-soa1.target=soa_server1` | 2.2.0+ |
